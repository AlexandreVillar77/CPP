...
/*   Updated: 2023/01/06 09:53:27 by avillar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (F.getIsSigned())
		std::cout << this->getName() << " cannot sign " << F.getName() << " because already signed" << std::endl;
...
void	Bureaucrat::executeForm(Form const & form)
{
	if (form.getIsSigned())
	{
		...
		std::cout << this->getName() << " couldn't execute " << form.getName() << " because not signed" << std::endl;
}
